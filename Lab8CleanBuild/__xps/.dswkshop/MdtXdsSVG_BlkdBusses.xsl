...
<xsl:template name="__Define_Busses__">
	
	<xsl:param name="drawarea_w"  select="500"/>
	<xsl:param name="drawarea_h"  select="500"/>
	
	<xsl:call-template name="Define_BusArrowsEastWest"> 
		<xsl:with-param name="bus_col"     select="$COL_FCBBUS"/>
	...
	<xsl:call-template name="Define_BusArrowsEastWest"> 
		<xsl:with-param name="bus_col"     select="$COL_TRSBUS"/>
		<xsl:with-param name="bus_type"    select="'TRANSPARENT'"/>
	</xsl:call-template>
	
	<xsl:call-template name="Define_BusArrowsEastWest"> 
		<xsl:with-param name="bus_col"     select="$COL_LMBBUS"/>
	...
	<xsl:call-template name="Define_BusArrowsNorthSouth"> 
		<xsl:with-param name="bus_type"    select="'OCM'"/>
	</xsl:call-template>
