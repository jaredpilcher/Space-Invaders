/* $Id: xuartlite_intr.c,v 1.1 2007/03/01 11:44:32 mta Exp $ */
/*****************************************************************************
*
...
* @return	None.
*
* @notes	There is no assert on the CallBackRef since the driver doesn't
...
void XUartLite_InterruptHandler(XUartLite *InstancePtr)
{
	 ...
	 * interrupt is active
	 */
	IsrStatus = XIo_In32(InstancePtr->RegBaseAddress +
